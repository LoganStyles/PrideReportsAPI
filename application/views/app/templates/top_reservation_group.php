                    ...
                    <div>
                        <div class="row">
                            <div class="form-group ">
                                ...
                                <div class="col-sm-12">
                                    <?php
                                    $topbuttons .= "<a href=\" " . base_url() . 'group/group/new' . " \" type=\"button\" class=\"btn " . $button_type_new . " \"><i class=\"fa fa-user\"></i>&nbsp;New Group</a>&nbsp;";
                                    $topbuttons.="<a href=\" " . base_url() . 'group/confirmed' . "\" type=\"button\" class=\"btn " . $button_type_confirmed . " \"><i class=\"fa fa-thumbs-up\"></i>&nbsp;Confirmed</a>&nbsp;";
                                    $topbuttons.="<a href=\" " . base_url() . 'group/staying' . "\" type=\"button\" class=\"btn " . $button_type_staying . " \"><i class=\"fa fa-home\"></i>&nbsp;In House</a>&nbsp;";
                                    $topbuttons.="<a href=\" " . base_url() . 'group/arriving' . "\" type=\"button\" class=\"btn " . $button_type_arriving . " \"><i class=\"fa fa-sign-in\"></i>&nbsp;Arriving Today</a>&nbsp;";
                                    $topbuttons.="<a href=\" " . base_url() . 'group/departing' . "\" type=\"button\" class=\"btn " . $button_type_departing . " \"><i class=\"fa fa-sign-out\"></i>&nbsp;Departing Today</a>&nbsp;";
                                    $topbuttons.="<a href=\" " . base_url() . 'group/cancelled' . "\" type=\"button\" class=\"btn " . $button_type_Cancelled . " \"><i class=\"fa fa-times-circle\"></i>&nbsp;Cancelled</a>&nbsp;";
                                    $topbuttons.="<a href=\" " . base_url() . 'group/all' . "\" type=\"button\" class=\"btn " . $button_type_all . " \"><i class=\"fa fa-users\"></i>&nbsp;All</a>&nbsp;";
                                    echo $topbuttons;
                                    ?>
                                </div>
                            </div> 
